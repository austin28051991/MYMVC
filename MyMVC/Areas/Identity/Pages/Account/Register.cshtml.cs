...
namespace MyMVC.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            if (!_roleManager.RoleExistsAsync(WebsiteRoles.Role_User).GetAwaiter().GetResult())
            {
                _roleManager.CreateAsync(new IdentityRole(WebsiteRoles.Role_User)).GetAwaiter().GetResult();
            }
            if (!_roleManager.RoleExistsAsync(WebsiteRoles.Role_Employee).GetAwaiter().GetResult())
            {
